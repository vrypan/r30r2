/*
 * TestU01 BigCrush test for ring30mix RNG
...
int main(void) {
    ...
    printf("═══════════════════════════════════════════════════════════\n");
    printf("  TestU01 BigCrush - ring30mix RNG\n");
    printf("═══════════════════════════════════════════════════════════\n");
    printf("\n");
    printf("Reading random data from stdin...\n");
    printf("This test will take approximately 8 hours.\n");
    printf("\n");

    /* Create generator */
    gen = unif01_CreateExternGenBits("ring30mix via stdin", stdin_gen);

    /* Run BigCrush battery */
